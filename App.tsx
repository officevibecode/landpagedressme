      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <a 
              href="#investimento" 
              className="hidden sm:block bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-full text-sm font-semibold transition-all shadow-lg shadow-blue-500/20"
            >
              {t.cta}
            </a>
          </div>
        ...
        <div className={`border-2 transition-all rounded-[3rem] p-8 md:p-12 shadow-2xl ${theme === 'dark' ? 'bg-zinc-900 border-blue-500/50' : 'bg-white border-blue-200'}`}>
          ...
          <div className={`text-center py-10 rounded-3xl border transition-all ${theme === 'dark' ? 'bg-black/40 border-white/5' : 'bg-slate-50 border-slate-100'}`}>
            ...
            <div className="flex flex-col space-y-4 items-center px-4">
              <a 
                href="#" 
                className="w-full max-w-md bg-blue-600 text-white text-xl font-bold py-5 rounded-2xl hover:scale-105 transition-transform flex items-center justify-center gap-2 shadow-xl shadow-blue-500/40"
              >
                {t.cta}
